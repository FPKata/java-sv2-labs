...
public class Architect {
    public static void main(String[] args) {
        Plan planSketch = new SketchPlan(135, "Családi ház");
        System.out.println(planSketch.getPagesOfDocumentation());

        Plan planPermit = new PermitPlan(135, "Családi ház",
                "Kiss József", "1124, Lejtő u. 20");
        System.out.println(planPermit.getPagesOfDocumentation());

        Plan planConstruction = new ConstructionPlan(135, "Családi ház",
                "Kiss József", "1124, Lejtő u. 20", 72);
